...
for(const marker of ['BANDALYTICS','DATA','PROCESS','PICKS','BOARD','GAMES','FILTERS','MY PICKS','MORE','bandalytics-mobile-standalone.js?v=6','position:fixed','__BANDALYTICS_MOBILE_FETCH_RETRY','iframe[src*="vercel.live"]'])if(!html.includes(marker))fail('missing HTML marker '+marker);
