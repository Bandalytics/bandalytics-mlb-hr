...
for(const marker of ['BANDALYTICS','Today’s Matchup Research','No scoring, tickets, or forced candidate count','bandalytics-mobile-standalone.js?v=2'])if(!html.includes(marker))fail('missing HTML marker '+marker);
