...
for(const marker of ['BANDALYTICS','MLB RESEARCH','DATA','PROCESS','PICKS','Today’s games','LINEUPS','TOP 3','PROPS','INSIGHTS','BOARD','GAMES','FILTERS','MY PICKS','MORE','bandalytics-mobile-standalone.js?v=3'])if(!html.includes(marker))fail('missing HTML marker '+marker);
for(const marker of ["version:'v3'",'researchOnly:true','projectionIsEvidence:false','scoringChanged:false','profileGateChanged:false','longshotRuleChanged:false','noForcedPool:true','approvedLayoutDirection:true','ELITE 6/6','MATCH 5/6','/api/projected-lineups','/api/profile-v38-candidate','/api/starter-damage-native','/api/environment-native'])if(!js.includes(marker))fail('missing JS marker '+marker);
