...
const required=[
  ...
  '/api/direct-preview?date=',
  '/api/feed-status?date=',
  '/api/research-status',
  '/api/pitchfit-native',
  'RESEARCH_READY',
  'Exact-ID Pitch Fit:',
  'parity_verified remains false',
  'scoring cutover remains disabled',
  'ZIP remains the scoring source of truth',
  'Use ZIP Production',
  'ZIP-Optional Parity Gates',
  'Legacy Lens Parity',
  'Duplicate identity audit',
  'Loaded ZIP vs Direct Field Replay',
  'BANDALYTICS_DIRECT_PARITY',
  'ZIP parity replay:',
  'different-date ZIP is never compared',
  'Preview date mismatch',
  'Feed date mismatch',
  'safeJSON(',
  'aria-expanded',
  "e.key==='Escape'",
