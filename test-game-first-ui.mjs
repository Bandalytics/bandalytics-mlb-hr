...
for(const marker of ["TODAY'S MLB SLATE",'Matchup Research','profileHighlighting:\'presentation-only\'','hydrationObserverHandoff:true','observerStarted','function attach()','observe();return true','modelScoringChanged:false','profileGateChanged:false','longshotRuleChanged:false','fullLineupVisible:true','LS 4/6'])if(!js.includes(marker))fail('missing JS marker '+marker);
