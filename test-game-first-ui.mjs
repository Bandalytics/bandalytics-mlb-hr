...
for(const marker of ["TODAY'S MLB SLATE",'Matchup Research','profileHighlighting:\'presentation-only\'','qualificationMarkerSystem:\'gold-profile-blue-longshot\'','pregameScreenCopy:true','hydrationObserverHandoff:true','mobileDocumentExtentGuard:true','function enforceDocumentExtent()','new ResizeObserver','visualViewport','observerStarted','function attach()','observe();return true','modelScoringChanged:false','profileGateChanged:false','longshotRuleChanged:false','fullLineupVisible:true','ELITE PROFILE • 6/6','PROFILE MATCH • 5/6','LONGSHOT CHECK • LS 4/6'])if(!js.includes(marker))fail('missing JS marker '+marker);
