...
const good={date:'2026-09-21',rows:[
  {player:'A',eligible_for_final_cut:true,final_cut:true,cut_type:null,cut_reason:null,exposure_state:'PRIORITY',ticket_paths:2,opportunity_verified:true,observed_starting_lineup:true,evidence_lanes:['PROFILE','HEAT','MATCHUP']},
  {player:'B',eligible_for_final_cut:true,final_cut:true,cut_type:null,cut_reason:null,exposure_state:'ONE_PATH',ticket_paths:2,lineup_type:'CONFIRMED',evidence_lanes:['PROFILE','VALUE']},
  {player:'C',eligible_for_final_cut:true,final_cut:true,cut_type:null,cut_reason:null,exposure_state:'INTENTIONAL_ZERO',ticket_paths:0,zero_path_reason:'Baseball-based no-ticket decision.',evidence_lanes:['PROFILE']},
  {player:'D',eligible_for_final_cut:true,final_cut:false,cut_type:'BASEBALL_CUT',cut_reason:'Suppressive matchup.',exposure_state:'UNCLASSIFIED',ticket_paths:0,evidence_lanes:['PROFILE']},
  {player:'E',eligible_for_final_cut:true,final_cut:false,cut_type:'COMFORT_CUT',cut_reason:'Comparable evidence but removed for safety/comfort.',exposure_state:'UNCLASSIFIED',ticket_paths:0,evidence_lanes:['PROFILE','HEAT']},
  {player:'Blocked',eligible_for_final_cut:false,readiness_state:'PENDING_LINEUP',final_cut:false,cut_type:null,cut_reason:null,exposure_state:'UNCLASSIFIED',ticket_paths:0,evidence_lanes:['PROFILE']}
],compression_watch:[
...
const badMissingCutType={date:'2026-09-21',rows:[{player:'A',eligible_for_final_cut:true,final_cut:false,cut_reason:'Cut but unlabeled.',exposure_state:'UNCLASSIFIED',ticket_paths:0}],tickets:[]};
const badMissingCutReason={date:'2026-09-21',rows:[{player:'A',eligible_for_final_cut:true,final_cut:false,cut_type:'COMFORT_CUT',exposure_state:'UNCLASSIFIED',ticket_paths:0}],tickets:[]};
...
const badBlockedPromoted={date:'2026-09-21',rows:[{player:'A',eligible_for_final_cut:false,readiness_state:'PENDING_LINEUP',final_cut:true,exposure_state:'INTENTIONAL_ZERO',ticket_paths:0,zero_path_reason:'No path'}],tickets:[]};
const badBlockedMislabeled={date:'2026-09-21',rows:[{player:'A',eligible_for_final_cut:false,readiness_state:'POLICY_BLOCKED',final_cut:false,cut_type:'COMFORT_CUT',cut_reason:'Should not be labeled',exposure_state:'UNCLASSIFIED',ticket_paths:0}],tickets:[]};
...
const cases={good,badNonstarter,badMismatch,badUnclassifiedZero,badZeroReason,badUnknownOpportunity,badOutsideFinalCut,badLane,badUnresolved,badMissingCutType,badMissingCutReason,badFinalRetainsCut,badBlockedPromoted,badBlockedMislabeled,badCompressionUnreviewed,badCompressionCutType,badCompressionKeepCutType};
