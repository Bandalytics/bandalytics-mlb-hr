export const V38_BASEBALL_CONVERGENCE_RULES={
  ...
  '4of6_iso+pitchfit_top_quartile':r=>r.candidate_rules?.['4of6_iso']===true&&['TOP_QUARTILE','TOP_DECILE'].includes(r.pitchfit_band),
  ...
  '4of6_iso+bbe_hrshape_top_quartile':r=>r.candidate_rules?.['4of6_iso']===true&&['TOP_QUARTILE','TOP_DECILE'].includes(r.bbe_band?.hrshape_band),
  ...
  '4of6_iso+pitchfit_top_quartile+bbe_hrshape_top_quartile':r=>r.candidate_rules?.['4of6_iso']===true&&['TOP_QUARTILE','TOP_DECILE'].includes(r.pitchfit_band)&&['TOP_QUARTILE','TOP_DECILE'].includes(r.bbe_band?.hrshape_band)
};
