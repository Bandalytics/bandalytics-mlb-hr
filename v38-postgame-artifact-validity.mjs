...
export function validateExactGamePostgameArtifact(z,{requiredFrom=V38_EXACT_GAME_POSTGAME_REQUIRED_FROM}={}){
  ...
  for(const r of z.rows){
    ...
    if(!validTime(r.start_time))return{valid:false,reason:'INVALID_START_TIME'};
...
export const V38_POSTGAME_ARTIFACT_VALIDITY=Object.freeze({protocol:'V38_POSTGAME_ARTIFACT_VALIDITY_V1',exact_game_required_from:V38_EXACT_GAME_POSTGAME_REQUIRED_FROM,row_identity:'GAMEPK_PLAYER_ID',doubleheader_safe:true,research_only:true,scoring_enabled:false,scoring_eligible:false});
