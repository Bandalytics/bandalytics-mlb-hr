...
import{validModifierArtifact,attachModifierBands,modifierCoverage}from'./v38-modifier-artifacts.mjs';
...
const pf=signed('V38_PITCHFIT_DISTRIBUTION_V1',[{player_id:1,fit_status:'TRUE',fit_score:55}]);
const bb=signed('V38_RECENT_BBE_DISTRIBUTION_V1',[{player_id:1,tracked_bbe:15,bbe:{hrshape:10}}]);
