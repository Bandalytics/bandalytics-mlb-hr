...
assert.match(post,/const version=19/);
...
assert.match(shellV12Css,/bx-game-hero/);
assert.match(shellV12Css,/bx-player-card\.primary/);
...
console.log('CLOUDFLARE MIGRATION V2 + BANDALYTICS MOBILE V12 TARGETED POLISH CONTRACT PASS');
