...
if(out.protocol!=='V38_CANARY_EXECUTION_FREEZE_V2'||out.canary_only!==true||out.production_normal_volume!==false) throw Error('bad protocol flags');
if(out.tickets!==3||out.max_ticket_budget!==4||out.tickets_detail.length!==3) throw Error('bad budget');
if(out.total_stake_units!==2.75||out.readiness.all_ticket_stakes_frozen!==true) throw Error('stake freeze failed');
