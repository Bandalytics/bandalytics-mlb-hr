...
if (typeof module !== "undefined") {
  module.exports = {
    ...
    simulateGame,
    runBandalyticsSim,
    americanOddsFromProb,
    impliedProbFromAmerican,
    evPerUnit,
  };
}

// Demo when run directly with Node.
if (typeof module !== "undefined" && require.main === module) {
  const demo = {
    awayCode:"MIA",
    homeCode:"WSH",
    sims:50000,
    environment:{parkRunFactor:1.01,weatherRunFactor:1.05},
    away:{
      offense:{wRCplus:105,xwOBA:0.327,ISO:0.168,barrelPct:8.1},
      lineup:{platoonIndex:4,qualityIndex:2},
      marketTeamTotal:4.9,
      marketBlend:0.18,
    },
    home:{
      offense:{wRCplus:96,xwOBA:0.312,ISO:0.153,barrelPct:7.0},
      lineup:{platoonIndex:1,qualityIndex:-1},
      marketTeamTotal:4.1,
      marketBlend:0.18,
    },
    awayStarter:{xERA:3.98,FIP:4.15,HR9:1.25,KminusBBPct:13.5},
    homeStarter:{xERA:3.67,FIP:3.95,HR9:1.05,KminusBBPct:15.0,platoonDamageIndex:4},
    awayBullpen:{xFIP:4.20,fatigueIndex:3},
    homeBullpen:{xFIP:4.45,fatigueIndex:6},
  };
  console.log(JSON.stringify(runBandalyticsSim(demo),null,2));
}
