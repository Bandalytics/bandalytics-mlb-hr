const gates=Object.freeze({
  ...
  market:{status:'BLOCKED',detail:'Native SportsGameOdds HR adapter is built and tested; live provider API key not connected.'},
  ...
  pitchfit:{status:'RESEARCH_READY',detail:'Native Baseball Savant Pitch Fit now runs on exact hitter MLBAM ID + exact pitcher MLBAM ID. Duplicate-name identity ambiguity is removed; legacy score parity remains unproven and scoring cutover stays off.'},
