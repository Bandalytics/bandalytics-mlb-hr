...
const MOBILE_FLAT_UI_SRC='bandalytics-mobile-flat-ui.js';
...
const MOBILE_SCROLL_CSS_VERSION='v3';
const MOBILE_FLAT_UI_VERSION='v1';
const MOBILE_FLAT_CSS_VERSION='v1';
...
if(!html.includes('/bandalytics-mobile-flat-ui.js'))html=html.replace('</body>',`<script src="/bandalytics-mobile-flat-ui.js?${MOBILE_FLAT_UI_VERSION}"></script></body>`);
