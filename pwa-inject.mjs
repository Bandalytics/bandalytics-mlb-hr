...
const tags=[
  ...
  '<link rel="stylesheet" href="/bandalytics-polish.css?v=25">',
...
console.log('BANDALYTICS MULTI-SPORT PWA + STARTER DAMAGE + LINEUP AUDIT + HISTORY RECOVERY PASS');
