...
const tags=[
  ...
  '<link rel="stylesheet" href="/bandalytics-polish.css?v=22">',
...
if(!html.includes('/v38-site-policy-ui.js'))html=html.replace('</body>','<script src="/v38-site-policy-ui.js?v=22"></script></body>');
...
if(!html.includes('/bandalytics-dashboard-shell.js'))html=html.replace('</body>','<script src="/bandalytics-dashboard-shell.js?v=22"></script></body>');
await fs.writeFile(INDEX,html);

const verify=await fs.readFile(INDEX,'utf8');
for(const marker of ['manifest.webmanifest','bandalytics-icon-192.png','apple-touch-icon','apple-mobile-web-app-capable','apple-mobile-web-app-title','/bandalytics-polish.css?v=22','/v38-site-policy-ui.js?v=22','/v38-clean-research-ui.js?v22','/bandalytics-dashboard-shell.js?v=22','bandalytics-public-critical','#bSourceRail','#bDirectBtn','#bDirectShade','#bDirectPanel','data-legacy-import-compat','id="file" type="file"','id="msg" class="msg"']){
...
console.log('BANDALYTICS MULTI-SPORT PWA + HYDRATED RESEARCH HUB PASS');
