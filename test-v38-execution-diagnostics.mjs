...
const body={
  ...
  rows:[
    ...
    {player:'Comfort Cut',final_cut:false,cut_type:'COMFORT_CUT',cut_reason:'Safety choice',ticket_paths:0,evidence_lanes:['PROFILE','HEAT'],hr_odds:1000},
    {player:'Baseball Cut',final_cut:false,cut_type:'BASEBALL_CUT',cut_reason:'Suppressive matchup',ticket_paths:0,evidence_lanes:['PROFILE'],hr_odds:700}
  ],
