...
const body={
  ...
  rows:[
    ...
    {player:'Comfort Cut',eligible_for_final_cut:true,final_cut:false,cut_type:'COMFORT_CUT',cut_reason:'Safety choice',ticket_paths:0,evidence_lanes:['PROFILE','HEAT'],hr_odds:1000},
    {player:'Baseball Cut',eligible_for_final_cut:true,final_cut:false,cut_type:'BASEBALL_CUT',cut_reason:'Suppressive matchup',ticket_paths:0,evidence_lanes:['PROFILE'],hr_odds:700},
    {player:'Pending Lineup',eligible_for_final_cut:false,readiness_state:'PENDING_LINEUP',lineup_verified:false,locked_policy:{label:'QUALIFIED_5OF6',gate_count:5},final_cut:false,cut_type:null,cut_reason:null,ticket_paths:0,evidence_lanes:['PROFILE']}
  ],
