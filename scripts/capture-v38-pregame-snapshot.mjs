...
console.log(`V38_SNAPSHOT_PATH=${path}`);console.log(`V38_SNAPSHOT_SUMMARY=${JSON.stringify({date,captured_at:capturedAt,games_total:games.length,pregame_games:pregameGames.length,excluded_started_games:excludedStarted.length,team_count:teamIds.length,player_count:items.length,profile_complete:out.profile_complete,sha256:digest})}`);
