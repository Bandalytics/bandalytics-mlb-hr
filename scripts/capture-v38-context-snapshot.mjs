...
console.log(`V38_CONTEXT_PATH=${path}`);console.log(`V38_CONTEXT_SUMMARY=${JSON.stringify({date,captured_at:capturedAt,pregame_games:out.pregame_game_count,confirmed_lineups:out.confirmed_lineups,lineup_rows:lineupRows.length,market_ok:out.market_ok,market_rows:marketRows.length,sha256})}`);
